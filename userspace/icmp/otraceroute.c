...
int otraceroute(struct in_addr, struct in_addr, struct in_addr, struct in_addr, struct in_addr *, int, int64 *);
int rtraceroute(struct in_addr, struct in_addr, struct in_addr *, int, int64 *difference);
...
*/
int rtraceroute(struct in_addr dst, struct in_addr src, struct in_addr *replyip, int ttl, int64 *difference)
{
	char *packet = NULL;
...
*/
int otraceroute(struct in_addr dst, struct in_addr src, struct in_addr esrc, struct in_addr edst, struct in_addr *replyip, int ttl, int64 *difference)
{
	char *packet = NULL;
	char *reply_buffer = NULL;
	struct iphdr *ip = NULL;
